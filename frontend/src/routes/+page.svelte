<script>
	...
	import { transcriptions, uploadProgress, isRecording } from '$lib/stores';
		...
		<div class="flex flex-col items-center justify-center px-4 pt-4 my-4">
			<div class="flex items-center space-x-3">
				<div class="relative">
					...
					<div class="absolute top-0 left-0 w-6 h-6 bg-red-500 rounded-full animate-ping opacity-75"></div>
				</div>
				<span class="text-lg font-mono text-red-400">RECORDING IN PROGRESS</span>
			</div>
			<span class="text-sm opacity-70 mt-2">Open the transcription modal to stop recording</span>
		</div>
	{:else}
		<button
